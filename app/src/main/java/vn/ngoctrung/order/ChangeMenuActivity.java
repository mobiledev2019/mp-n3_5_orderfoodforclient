...
public class ChangeMenuActivity extends Activity {
	...
	protected void kiem_tra_checkbox() {
		...
		if (chkMon1.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon1));
			gia_duoc_chon.add(getGia(getString(R.string.mon1_gia)));
			them_so_phan(edt1);

		}
		if (chkMon2.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon2));
			gia_duoc_chon.add(getGia(getString(R.string.mon2_gia)));
			them_so_phan(edt2);
		}
		if (chkMon3.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon3));
			gia_duoc_chon.add(getGia(getString(R.string.mon3_gia)));
			them_so_phan(edt3);
		}
		if (chkMon4.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon4));
			gia_duoc_chon.add(getGia(getString(R.string.mon4_gia)));
			them_so_phan(edt4);
		}
		if (chkMon5.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon5));
			gia_duoc_chon.add(getGia(getString(R.string.mon5_gia)));
			them_so_phan(edt5);
		}
		if (chkMon6.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon6));
			gia_duoc_chon.add(getGia(getString(R.string.mon6_gia)));
			them_so_phan(edt6);
		}
		if (chkMon7.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon7));
			gia_duoc_chon.add(getGia(getString(R.string.mon7_gia)));
			them_so_phan(edt7);
		}
		if (chkMon8.isChecked() && (!so_ban.equals(""))) {
			so_mon += 1;
			mon_duoc_chon.add(getString(R.string.mon8));
			gia_duoc_chon.add(getGia(getString(R.string.mon8_gia)));
			them_so_phan(edt8);
		}
		...
		protected String doInBackground(String... arg0) {
			try {
				...
				HttpPost httppost = new HttpPost(
						getString(R.string.ipsv)+"/qlnh/load_order.php");
